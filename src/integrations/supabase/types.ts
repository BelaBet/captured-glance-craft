  ...
  public: {
    Tables: {
      ...
      profiles: {
        ...
        Update: { avatar_url?: string | null; color_theme?: string | null; dark_mode?: boolean | null; full_name?: string; id?: string; last_active_date?: string | null; preferred_time?: string | null; streak_days?: number | null; updated_at?: string; user_id?: string }
        Relationships: []
      }
    }
    Views: { [_ in never]: never }
    Functions: {
      check_compass_chat_rate_limit: { Args: { p_max_requests?: number; p_window_seconds?: number }; Returns: boolean }
      record_compass_activity: { Args: Record<PropertyKey, never>; Returns: number }
    }
