  ...
  public: {
    Tables: {
      ...
      goals: {
        ...
        Update: { created_at?: string; id?: string; progress?: number | null; status?: string; title?: string; updated_at?: string }
        Relationships: []
      }
      insights: {
      ...
      profiles: {
        ...
        Insert: { avatar_url?: string | null; color_theme?: string | null; created_at?: string; id?: string; full_name?: string; user_id: string }
        Update: { avatar_url?: string | null; color_theme?: string | null; dark_mode?: boolean | null; full_name?: string; id?: string; last_active_date?: string | null; preferred_time?: string | null; streak_days?: number | null; updated_at?: string }
        Relationships: []
      }
    }
